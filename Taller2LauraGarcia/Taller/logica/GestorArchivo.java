...
public class GestorArchivo {
	...
	public  ArrayList<LiderGimnasio> abrirArchivoGym(String nombreArchivo) throws FileNotFoundException{
		 ...
		 while (lectura.hasNextLine()) {
			 ...
			 LiderGimnasio li = new LiderGimnasio(numeroGimnasio, nombreLider, estado, cantidadPokemones, listaPokemones);
	...
	public  ArrayList<Pokemon> abrirArchivoPokemon(String nombreArchivo) throws FileNotFoundException{
		 ...
		 while (lectura.hasNextLine()) {
			 ...
			 Pokemon p = new Pokemon(pokemon, habitat, porcentajeParticipacion, vida, ataque, defensa, ataqueEspecial, defensaEspecial, velocidad, tipo);
